...
<head>
    ...
    <title>Terre</title>
    <link rel="stylesheet" href="css/terreV8.css">
...
<body>
    ...
    <!--TERRE-->
    <section class="sectionTerreResponsive ml-5">
        <div class="d-flex justify-content-center mt-5">
    ...
    <section class="ville">
        ...
        <div class="imageResponsive575px mt-5 modifEspaceBlanc" style="margin-bottom: -4rem;"> 
            ...
            <div class="float-right p-5 blocTexteVille" style="padding-bottom: 1rem!important;">
